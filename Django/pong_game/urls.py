...
urlpatterns = [
    ...
    # path('<int:game_id>/state/', views.get_game_state, name='get_pong_game_state'), #Not sure to use
    # path('<int:game_id>/update_score/', views.update_score, name='update_pong_score'), #Not sure to use
